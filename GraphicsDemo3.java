...
public class GraphicsDemo3 extends Canvas
{
    public void paint(Graphics g)
    {
        ...
        g.setFont(new Font("Calibri", Font.BOLD+Font.ITALIC, 60)); // 60pt calibri bold and italic
        g.drawString("Leander lions", 300, 350);
        
        g.setColor(Color.blue);
        g.setFont(Font.decode("Calibri-BOLDITALIT-60")); // same as above but different
        g.drawString("Leander lions", 290 ,360);
        
        g.setColor(Color.black);
        g.setFont(new Font(null)); // restores default font
    ...
    {
        JFrame win = new JFrame("Graphics Demo 3: Fonts and lines");
        win.setSize(800,600);
